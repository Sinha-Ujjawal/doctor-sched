...
def main():
    ...
    leaves = [
        [DR_MADHURI_TRIPATHI, (20, 21)],
        [DR_AMIT_TRIPATHI, (20, 21)],
    ]
    # Unavailable shifts
    for dt in dates:
        day = dt.day
    ...
    # Unofficial leaves:
    #   DR_RASHMI_SHARMA will not be available on 13, 14 and 15
    unavailable_shifts[(DR_RASHMI_SHARMA, 13)] = all_shifts
    unavailable_shifts[(DR_RASHMI_SHARMA, 14)] = all_shifts
    unavailable_shifts[(DR_RASHMI_SHARMA, 15)] = all_shifts
    ...
    first_night_off = DR_SAUMYA_SHUKLA
