...
def main():
    ...
    unofficial_leaves = [
        [DR_MINAKSHI_MISHRA, [9, 10, 28, 29, 30]],
        [DR_RASHMI_SHARMA, list(range(22, 30 + 1))],
        [DR_KRITIKA_PRASAD, [7, 8, 9, 10, 11]],
    ]
    ...
    for dt in dates:
        ...
        if week in (weeks.index("Thu"),):
            fixed_shifts[(DR_ABHILASHA_MISHRA, day)] = (
                ["ot_duty", "night"] if day != 6 else ["ot_duty"]
            )
    ...
    # Custom fixed shifts:
    # DR_KRITIKA_PRASAD will do morning and evening on 2nd (Sunday)
    # DR_KRITIKA_PRASAD will do Night on 6th
    # DR_RASHMI_SHARMA will do morning and evening on 9th (Sunday)
    # DR_HITESH_KUREEL will do Night on 21st
    fixed_shifts[(DR_KRITIKA_PRASAD, 2)] = ["morning", "evening"]
    fixed_shifts[(DR_KRITIKA_PRASAD, 6)] = ["night"]
    fixed_shifts[(DR_RASHMI_SHARMA, 9)] = ["morning", "evening"]
    fixed_shifts[(DR_HITESH_KUREEL, 21)] = ["night"]
