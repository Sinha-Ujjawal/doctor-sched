...
def main():
    """
    NOTES:
        DR_MADHURI_TRIPATHI is back
        DR_ABHILASHA_MISHRA left
        DR_AKASHDEEP_GUPTA 2 Unavailable
        DR_KRITIKA_PRASAD  1-4 Unavailable
        DR_RASHMI_SHARMA   1-4 Unavailable
        DR_MINAKSHI_MISHRA 29-30 Unavailable 31st Night
        28,29,30,31 (Unavailable):
            DR_KRITIKA_PRASAD
            DR_AKASHDEEP_GUPTA
            DR_RAJAT_GUPTA
            DR_VIKAS_VERMA
        DR_MADHURI_TRIPATHI will not do Morning duty except on Sunday
    ...
    unofficial_leaves: list[tuple[str, list[int]]] = [
        (DR_KRITIKA_PRASAD, range_list(1, 4) + range_list(28, 31)),
        (DR_RASHMI_SHARMA, range_list(1, 4)),
        (DR_AKASHDEEP_GUPTA, [2] + range_list(28, 31)),
        (DR_RAJAT_GUPTA, range_list(28, 31)),
        (DR_MINAKSHI_MISHRA, range_list(29, 30)),
        (DR_VIKAS_VERMA, range_list(28, 31)),
    ]
    ...
    fixed_shifts[(DR_MINAKSHI_MISHRA, 31)] = ["night"]
    ...
    minmax_night_shifts = {
        # EMOs
        DR_KRITIKA_PRASAD: (3, 4),
        DR_HITESH_KUREEL: (3, 4),
        DR_RAJAT_GUPTA: (3, 4),
        DR_AKASHDEEP_GUPTA: (3, 4),
        DR_VIKAS_VERMA: (3, 4),
        DR_MADHURI_TRIPATHI: (3, 4),
        # Senior EMOs
    ...
    for dt in dates:
        ...
        #         ]
        #     )
    first_night_off = DR_AKASHDEEP_GUPTA
